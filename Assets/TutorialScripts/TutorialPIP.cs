...
public class TutorialPIP : MonoBehaviour
{
    ...
    private string[] tutorial_lines =
    {
        ...
        "I pre prepared the drink for you. This time it's your task to prepare the fruit.",
        "The containers with the fruits are on the left side of the bar.",
        "Now grab the red fruit and plane it on the cutting board on the right. But be careful! It's extremly volatile and will explode if handled too roughly.",
